...
#Tavily - internet search tool, like Google but for AI apps. 
...
def web_search_agent(query: str) -> dict:
    ...
    try:
        ...
        results = client.search(
            ...
            max_results=7  # 7 sources gives better coverage without overwhelming Claude's context
        )
        ...
        return {
            "content": "Web search unavailable. Please try again.",
            "sources": [],
            "agent": "web_search"
        }